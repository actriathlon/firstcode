  ...
  subroutine cleanup
    ...
    do a = 1,nclients
       write(108,*) sumclient(a,:),sumsep/sumclient(a,clientlength+1),bulksumsep/sumclient(a,2*(clientlength+1)),unbound(a,:),&
        totalbindevents(1),totalbindevents(2),locb(1),locb(2),bindinghist(:),bindingsitehist(:)
    end do
...
zloc(protcoords(m,l)%x) = zloc(protcoords(m,l)%x) + 1
           if((protcoords(m,l)%z < 3) .or. (protcoords(m,l)%z> (gridsize-2))) then  
        if((cell(modulo(protcoords(m,l)%x,gridsize)+1,protcoords(m,l)%y,protcoords(m,l)%z)%bm/=0)) then
        pr =cell(modulo(protcoords(m,l)%x,gridsize)+1,protcoords(m,l)%y,protcoords(m,l)%z)%bm
        str =cell(modulo(protcoords(m,l)%x,gridsize)+1,protcoords(m,l)%y,protcoords(m,l)%z)%bl
        ...
        if((cell(modulo(protcoords(m,l)%x-2,gridsize)+1,protcoords(m,l)%y,protcoords(m,l)%z)%bm/=0)) then
        pr=cell(modulo(protcoords(m,l)%x-2,gridsize)+1,protcoords(m,l)%y,protcoords(m,l)%z)%bm 
        str=cell(modulo(protcoords(m,l)%x-2,gridsize)+1,protcoords(m,l)%y,protcoords(m,l)%z)%bl 
           if(protcoords(pr,str)%type==1) then         
                control = control+1
                goto 7000
        end if
