...
dpcomclusterinit%x=gridsize/2.0
dpcomclusterinit%y=gridsize/2.0
dpcomclusterinit%z=gridsize/2.0
...
!locb(1) = locb(1) - (int(totalenergy)+control)
!if(control==0) then
! totalbindevents(1)=totalbindevents(1)+1
!totalbindevents(2) = totalbindevents(2) -1
!end if
       ...
       CASE ('CLIENT')
        ...
        vtype = vtype+1
          ...
          do f = 1,specieslen(vtype)
             ...
             if(client(vtype,f)%type>mtype) mtype = client(vtype,f)%type
          end do
