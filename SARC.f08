program move
  ...
  integer:: cracc,crrej,raacc,rarej,rerej,reacc,pvacc,pvrej,nprotein1,nprotein2,nspecies,mtype,timebase
...
!write(6,*) 'c'
     ...
     if ((mod(time-equilib,1000000) == 0) .and. (film .eqv. .true.) ) then
   ...
   call positioning
     ...
     if (mod(time-equilib,outputrate) == 0) then
...
!call clustercount
     ...
     !write(6,*) 'gfd'
     if (modulo(time,100000) == 0 .and. debugyes .eqv. .true.) then
        !write(6,*) 'debug start'
        call debug
        !write(6,*) 'debug fin'
        end if
        if(modulo(time,100000) ==0) call energy(.FALSE.)
!if((time> 13600) .and. (modulo(time,20) == 0)) call energy
        !write(6,*) 'debug success'
     if (fail .eqv. .true.) then
        write(6,*) 'step= ', time, 'FAIL'
     else if((time > equilib) .and. modulo(time-equilib,1000000) == 0) then
        write(6,*) 'step =',time
     end if
