program move
  ...
  outputrate = (maxtime-equilib)/1000
  clracc = 0
  clratt = 0
  cltacc = 0
  cltatt = 0
  ...
  do timebase = 1,maxtime,1
     ...
     !end if
          if(time ==63385) then
        write(6,*) 'info a',protcoords(74,15)
     write(6,*) 'info b',protcoords(74,20)
        end if
...
contains
  ...
  subroutine foundationrestart
    ...
    integer::m,l,no1,no2,maxl,z
    character(len = 10) :: BIN
    read(23,*) lastruntime,totrmsbrute
    do m = 1,nprotein,1
