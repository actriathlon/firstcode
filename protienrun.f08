    ...
    !else if (l == 1000) then
       ...
       if (choose3 <= 1.0/5) then
          ...
          do b = l+1,maxlength 
             ...
             !write(93,*) 'x = ', tempcoord(m,b)%x, modulo(protcoords(m,l)%x - dely(m,b)-1,gridsize)+1, &
                  !'y = ', tempcoord(m,b)%y,modulo(protcoords(m,l)%y + delx(m,b)-1,gridsize)+1
          ...
          do b =l+1,maxlength 
             tempcoord(m,b)%x = modulo(protcoords(m,l)%x + dely(b)-1,gridsize)+1
             tempcoord(m,b)%y = modulo(protcoords(m,l)%y - delx(b)-1,gridsize)+1
             !write(93,*) 'x = ', tempcoord(m,b)%x, 'y = ', tempcoord(m,b)%y                      
          end do
          ...
          do b =l+1,maxlength 
             ...
             !write(93,*) 'x = ', tempcoord(m,b)%x, 'z = ', tempcoord(m,b)%z       
          end do
          do b = l+1,maxlength 
             do f = 1,nprotein
                do g = 1,maxlength
