program move
  ...
  double precision :: actualchainlength,random,totiso,choose1
  ...
  integer :: successful,reject,pivotlimit,maxpiv,maxlength1,maxlength2,q,d,u,sm,qt,ft,gt,scans,roatt,roacc
