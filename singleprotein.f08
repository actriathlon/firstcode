...
if (pivotx .eqv. .true.) then
   ...
   dy11 = min(modulo(protcoords(m,l)%y - protcoords(m,l-1)%y,gridsize), gridsize - &
        modulo(protcoords(m,l)%y - protcoords(m,l-1)%y,gridsize))
   dy12 = min(modulo(protcoords(m,l+1)%y - protcoords(m,l+2)%y,gridsize), gridsize - &
        modulo(protcoords(m,l+1)%y - protcoords(m,l+2)%y,gridsize))

      dz11 = min(modulo(protcoords(m,l)%z - protcoords(m,l-1)%z,gridsize), gridsize - &
        modulo(protcoords(m,l)%z - protcoords(m,l-1)%z,gridsize))
   dz12 = min(modulo(protcoords(m,l+1)%z - protcoords(m,l+2)%z,gridsize), gridsize - &
        modulo(protcoords(m,l+1)%z- protcoords(m,l+2)%z,gridsize))
   
             if ( dy11 ==1.0 .and. dy12 ==1.0 .and. &
                  modulo(protcoords(m,l)%y - protcoords(m,l+1)%y,gridsize) ==0.0) then
                dy = protcoords(m,l)%y - protcoords(m,l-1)%y
                if (dy > 1.5) dy = -1.0
                if (dy < 1.5) dy = 1.0
                dz = 0.0 
             else  if (dz11 ==1.0 .and. dz12 ==1.0 .and. &
             ...
             if (probs <= (1.0/3)) then
                ...
                do g = 1,nprotein
                   do f = 1,maxlength
                      if(protcoords(g,f)%y == modulo(protcoords(m,l)%y-dy-1,gridsize)+1 .and. &
                           protcoords(g,f)%x == modulo(protcoords(m,l)%x-2,gridsize)+1 .and. &
                           protcoords(g,f)%z == modulo(protcoords(m,l)%z-dz-1,gridsize)+1 .and. &
                           protcoords(g,f)%y == modulo(protcoords(m,l+1)%y-dy-1,gridsize)+1 .and. &
                           protcoords(g,f)%x == modulo(protcoords(m,l+1)%x-2,gridsize)+1 .and. &
                           protcoords(g,f)%z == modulo(protcoords(m,l+1)%z-dz-1,gridsize)+1) then
                         crankcont = .false.
                         goto 43
                      else
                         continue
                ...
                protcoords(m,l)%y = modulo(protcoords(m,l)%y-dy-1,gridsize)+1
                protcoords(m,l)%z = modulo(protcoords(m,l)%z-dz-1,gridsize)+1
                protcoords(m,l+1)%y = modulo(protcoords(m,l+1)%y-dy-1,gridsize)+1
...
!!!!!!!!!!pivot y
          ...
          if (pivoty .eqv. .true.) then
                ...
                dx11 = min(modulo(protcoords(m,l)%x - protcoords(m,l-1)%x,gridsize), gridsize - &
        modulo(protcoords(m,l)%x - protcoords(m,l-1)%x,gridsize))
   dx12 = min(modulo(protcoords(m,l+1)%x - protcoords(m,l+2)%x,gridsize), gridsize - &
        modulo(protcoords(m,l+1)%x - protcoords(m,l+2)%x,gridsize))
      dz11 = min(modulo(protcoords(m,l)%z - protcoords(m,l-1)%z,gridsize), gridsize - &
        modulo(protcoords(m,l)%z - protcoords(m,l-1)%z,gridsize))
   dz12 = min(modulo(protcoords(m,l+1)%z - protcoords(m,l+2)%z,gridsize), gridsize - &
        modulo(protcoords(m,l+1)%z - protcoords(m,l+2)%z,gridsize))
             
             if (dx11 ==1.0 .and. dx12 ==1.0 .and. &
             ...
             if (probs <= (1.0/3)) then
              ...
              successful = successful +1
                ...
                do g = 1,nprotein
                   do f = 1,maxlength
                      if(protcoords(g,f)%x == modulo(protcoords(m,l)%x-dx-1,gridsize)+1 .and. &
                           protcoords(g,f)%y == modulo(protcoords(m,l)%y-2,gridsize)+1 .and. &
                           protcoords(g,f)%z == modulo(protcoords(m,l)%z-dz-1,gridsize)+1 .and. &
                           protcoords(g,f)%x == modulo(protcoords(m,l+1)%x-dx-1,gridsize)+1 .and. &
   ...
   dx12 = min(modulo(protcoords(m,l+1)%x - protcoords(m,l+2)%x,gridsize), gridsize - &
        modulo(protcoords(m,l+1)%x - protcoords(m,l+2)%x,gridsize))
             ...
             if (dy11 ==1.0 .and. dy12 ==1.0 .and. &
                ...
                if (dy < 1.5) dy = 1.0
                dx = 0.0 
             else  if (dx11 ==1.0 .and. dx12 ==1.0 .and. &
                ...
                do g = 1,nprotein
                   do f = 1,maxlength
                      if(protcoords(g,f)%y == modulo(protcoords(m,l)%y-dy-1,gridsize)+1 .and. &
                           ...
                           protcoords(g,f)%x == modulo(protcoords(m,l)%x-dx-1,gridsize)+1 .and. &
                           protcoords(g,f)%y == modulo(protcoords(m,l+1)%y-dy-1,gridsize)+1 .and. &
                           protcoords(g,f)%z == modulo(protcoords(m,l+1)%z-2,gridsize)+1 .and. &
                           protcoords(g,f)%x == modulo(protcoords(m,l+1)%x-dx-1,gridsize)+1) then
                         crankcont = .false.
                         goto 43
                      else
                         continue
  ...
  subroutine rightanglemove
    ...
    rac = .true.
       ...
       if (abs(mod(protcoords(m,l+1)%x - protcoords(m,l-1)%x,gridsize)) /= 2.0 &
            ...
            .and. abs(mod(protcoords(m,l+1)%z - protcoords(m,l-1)%z,gridsize)) /= 2.0 ) then
          rightangle = .true.
       else 
          rightangle = .false.
       end if
...
write(99,*) delx(m,g),dely(m,g),delz(m,g)
end do
      if (choose3 <= 1.0/5) then
         do b = l+1,maxlength 
            do f = 1,nprotein
               do g = 1,maxlength
                  if(modulo(protcoords(m,l)%x - dely(m,b),gridsize)  == protcoords(f,g)%x .and. &
                       modulo(protcoords(m,l)%y + delx(m,g),gridsize) == protcoords(f,g)%y &
         ...
         do b = l+1,maxlength 
            protcoords(m,b)%x = modulo(protcoords(m,l)%x - dely(m,b),gridsize)
            protcoords(m,b)%y = modulo(protcoords(m,l)%y + delx(m,b),gridsize)
         ...
         do b = l+1,maxlength 
            do f = 1,nprotein
               do g = 1,maxlength
                  if(modulo(protcoords(m,l)%x + dely(m,b),gridsize) == protcoords(f,g)%x .and. &
                       modulo(protcoords(m,l)%y - delx(m,b),gridsize) == protcoords(f,g)%y &
                       .and. protcoords(m,b)%z == protcoords(f,g)%z) then
                     pivcont = .false.
                     goto 75
                  end if
        ...
        !write(6,*) '2a'
         ...
         do b = l+1,maxlength 
            do f = 1,nprotein
               do g = 1,maxlength
                  if(modulo(protcoords(m,l)%x - delx(m,b),gridsize) == protcoords(f,g)%x .and. &
                       modulo(protcoords(m,l)%y - dely(m,b),gridsize) == protcoords(f,g)%y &
                       .and. protcoords(m,b)%z == protcoords(f,g)%z) then
                     pivcont = .false.
                     goto 75
                  end if
         ...
         do b =l+1,maxlength                 
            protcoords(m,b)%x = modulo(protcoords(m,l)%x - delx(m,b),gridsize)
            protcoords(m,b)%y = modulo(protcoords(m,l)%y - dely(m,b),gridsize)
            !protcoords(t,m,b)%z = protcoords(t,m,b)%z + mod(protcoords(t,m,l)%y-protcoords(t,m,b)%y,gridsize
            successful = successful + 1
         ...
         do b = l+1,maxlength 
            do f = 1,nprotein
               do g = 1,maxlength
                  if(modulo(protcoords(m,l)%x - delz(m,b),gridsize) == protcoords(f,g)%x .and. &
                       modulo(protcoords(m,l)%z + delx(m,b),gridsize) == protcoords(f,g)%z &
         ...
         do b =l+1,maxlength 
            protcoords(m,b)%x = modulo(protcoords(m,l)%x - delz(m,b),gridsize)
            protcoords(m,b)%z = modulo(protcoords(m,l)%z + delx(m,b),gridsize)
            !protcoords(t,m,b)%z = protcoords(t,m,b)%z + mod(protcoords(t,m,l)%y-protcoords(t,m,b)%y,gridsize
            successful = successful + 1
...
delz(m,g) = protcoords(m,g)%z - protcoords(m,l)%z
      ...
      if (choose3 <= 1.0/5) then
         ...
         do b =l-1,1,-1                 
            protcoords(m,b)%x = modulo(protcoords(m,l)%x -delx(m,l),gridsize)
            protcoords(m,b)%y = modulo(protcoords(m,l)%y - dely(m,b),gridsize)
            !protcoords(t,m,b)%z = protcoords(t,m,b)%z + mod(protcoords(t,m,l)%y-protcoords(t,m,b)%y,gridsize
            successful = successful + 1
...
dz = 0.0
                ...
                do l =1,maxlength-1
                   protcoords(c,maxlength-l+1)%x = protcoords(c,maxlength-l)%x
                   protcoords(c,maxlength-l+1)%y = protcoords(c,maxlength-l)%y
                   protcoords(c,maxlength-l+1)%z = protcoords(c,maxlength-l)%z
                 
!successful = successful+1
                end do
              
                protcoords(c,1)%x = modulo(protcoords(c,1)%x - dx,gridsize)
                protcoords(c,1)%y = modulo(protcoords(c,1)%y - dy,gridsize)
                protcoords(c,1)%z = modulo(protcoords(c,1)%z - dz,gridsize)
...
reptforward = reptforward + 1                
                ...
                protcoords(c,maxlength)%x = modulo(protcoords(c,maxlength)%x - dx,gridsize)
                protcoords(c,maxlength)%y = modulo(protcoords(c,maxlength)%y - dy,gridsize)
                protcoords(c,maxlength)%z = modulo(protcoords(c,maxlength)%z - dz,gridsize)
...
71        if (endcont .eqv. .false.) then
  ...
  subroutine comfind
    ...
    do m = 1,nprotein
       ...
       comz = 0.0
       do l = 2,maxlength
          comx = comx + mod(protcoords(m,l)%x-protcoords(m,l-1)%x,gridsize)
          comy = comy + mod(protcoords(m,l)%y-protcoords(m,l-1)%y,gridsize)
          comz = comz + mod(protcoords(m,l)%z-protcoords(m,l-1)%z,gridsize)
