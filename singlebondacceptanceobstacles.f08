...
dpcomclusterinit%x=real(gridsize)/2.0
dpcomclusterinit%y=real(gridsize)/2.0
dpcomclusterinit%z=real(gridsize)/2.0
...
if ((protcoords(m,l)%type /=protcoords(protcoords(m,l)%am,protcoords(m,l)%al)%type)) then 
...
if( (protcoords(m,l)%type /=protcoords(protcoords(m,l)%bm,protcoords(m,l)%bl)%type)) then 
                        if(protcoords(m,l)%a111==0) then
                                unboundcount = unboundcount+1
...
if((protcoords(m,l)%type /=protcoords(protcoords(m,l)%cm,protcoords(m,l)%cl)%type)) then 
                        if(protcoords(m,l)%a111==0) then
                                unboundcount = unboundcount+1
...
if( (protcoords(m,l)%type /=protcoords(protcoords(m,l)%dm,protcoords(m,l)%dl)%type)) then 
                        if(protcoords(m,l)%a111==0) then
                                unboundcount = unboundcount+1
...
if( (protcoords(m,l)%type /=protcoords(protcoords(m,l)%em,protcoords(m,l)%el)%type)) then 
                        if(protcoords(m,l)%a111==0) then
                                unboundcount = unboundcount+1
...
if( (protcoords(m,l)%type /=protcoords(protcoords(m,l)%fm,protcoords(m,l)%fl)%type)) then 
                        if(protcoords(m,l)%a111==0) then
                                unboundcount = unboundcount+1
...
integer::g,m,l
	...
	write(6,*) 'g',g,vtype,nclientspecies,nprotein,nclients
