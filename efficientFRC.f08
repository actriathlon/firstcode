...
!write(6,*) 'corresponding info',tempcluscoord(464,6)%x,tempcluscoord(464,6)%y,tempcluscoord(464,6)%z
    ...
    do rvv = 1,clsize
       vv = cllist(rvv)
       call clustermove(vv,dx,dy,dz,tempcluscoord,moveallow,ctbo,cllist,cl)
...
!write(6,*) 'help', protcoords(182,4)
  ...
  subroutine clustermove(chainno,delx,dely,delz,tempcluscoord,moveallow,ctbo,cllist,cl)
