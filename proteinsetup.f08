...
47    if (protpass ==1) then
      ...
      if(speciesselect ==1) maxl = maxlength1
      if(speciesselect ==2) maxl = maxlength2 
      
      if(spcount1 == nprotein1) then
         maxl = maxlength2
         speciesselect = 2
      else if(spcount2 == nprotein2) then
         maxl = maxlength1
         speciesselect = 1
      else
         continue
...
15          if (control ==1) then
          ...
          do l = 1,maxl
             write(19,*) protcoords(m,l)%species ,    protcoords(m,l)%x,    protcoords(m,l)%y,    protcoords(m,l)%z
               ...
               write(6,*) speciesselect,spcount1,spcount2
       end do
