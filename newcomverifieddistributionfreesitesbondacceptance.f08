...
integer::firstrun,ft,gt,x,halfbox,limiting,an,ax
...
integer::sumconn,sumen,sumconncount,normen,normconn
  ...
  type rprot
     real :: x,y,z
     integer::bond,type,a111,a11n
  end type rprot


  type prottemp
     integer :: x,y,z,am,al,bm,bl,cm,cl,dm,dl,em,el,fm,fl,a111,a11n
  end type prottemp


  type rprot2
     real :: a1,a2,a3,a4,a5,a6,linker
     integer::x,y,z,bond,type,a111,a11n
  end type rprot2
...
write(6,*) 'time',t1,t2
     ...
     do m = 1,nprotein,1
        read(21,*)  BIN,rx,ry,rz,ax,an
        !write(6,*) BIN,rx,ry,rz
...
totblhist(l) = totblhist(l) + blhist(l)
  ...
  subroutine clustercount
    ...
    integer :: acconn,cconn,atconn,tconn,a,b,c,d,a2,b2,c2,d2,bdir2,bdir3
...
END SELECT
                         ...
                         if((chains(m,l)%a111==bdir2).and.(chains(g,f)%a111==bdir3).and. &
                        (chains(m,l)%a11n==g).and.(chains(g,f)%a11n==m) .and. &
                        (int(interenergy(chains(g,f)%type,chains(m,l)%type))/= 0)) then
...
sumconncount = sumconncount + maxclus
  ...
  subroutine energy(init2)
    ...
    integer :: dx,dy,dz,m,l,f,g,bdir,delx,dely,delz,maxlengthss,maxl,bdir2,bdir3
