...
results = np.loadtxt('0.1/trendl.dat')
...
for nm in range(5):
	...
	results2 = np.loadtxt('0.2/trendl.dat')
	...
	results3 = np.loadtxt('0.3/trendl.dat')
	...
	results4 = np.loadtxt('0.4/trendl.dat')
	...
	results5 = np.loadtxt('0.5/trendl.dat')
	...
	results6 = np.loadtxt('0.6/trendl.dat')
	...
	results7 = np.loadtxt('0.8/trendl.dat')
	...
	results8 = np.loadtxt('0.01/trendl.dat')
	...
	results9 = np.loadtxt('0.05/trendl.dat')
	...
	results10 = np.loadtxt('0.15/trendl.dat')
	...
	combc[9] = (results10[nm,9])
        ...
        results11 = np.loadtxt('0.25/trendl.dat')
	...
	results12 = np.loadtxt('0.35/trendl.dat')
	...
	results13 = np.loadtxt('0.7/trendl.dat')
	...
	#print a
	tr='valency'+' '+str(nm+1)
	plt.plot(z,comba/(nm+1),'x',label=tr)
...
#plt.figure(1)
#plt.subplot(221)
plt.title("Client Binding in Gas vs Vacuum")
plt.xlabel("Density of Gas",fontsize=12)
plt.ylabel("Gas vs Vacuum",fontsize=12)
plt.ylim(0.0,None)
plt.xlim(0.0,0.8)
